...
public class MenuItemController {
    ...
    public MenuItem get(@PathVariable(name = "restaurant_id")
        ...
        return checkNotFoundOptional(repository.get(id,
                restaurantId,
    ...
    public List<MenuItem> getByRestaurantId(@PathVariable(name = "restaurant_id")
