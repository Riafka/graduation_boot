...
public class MenuItemTestData {
    ...
    public static final MenuItem salmonWithLemon = new MenuItem(SALMON_WITH_LEMON_ID, blueLagoon, "Salmon with lemon", 50000, LocalDate.now());
    ...
    public static final MenuItem krabbyMeal = new MenuItem(KRABBY_MEAL_ID, krustyKrabs, "Krabby meal", 25050, LocalDate.now());
    public static final MenuItem krabbyPatty = new MenuItem(KRABBY_PATTY_ID, krustyKrabs, "Krabby Patty", 26030, LocalDate.now());
    ...
    public static final MenuItem sailorsSurprise = new MenuItem(SAILORS_SURPRISE_ID, krustyKrabs, "Sailors Surprise", 30000, LocalDate.now());

    public static final MenuItem crayfishSalad = new MenuItem(CRAYFISH_SALAD_ID, riga, "Crayfish salad", 50000, LocalDate.now());
    public static final MenuItem onionSoup = new MenuItem(ONION_SOUP_ID, riga, "Onion soup", 75000, LocalDate.now());
    public static final MenuItem butterBeanRagout = new MenuItem(BUTTER_BEAN_RAGOUT_ID, riga, "Butter bean ragout", 80000, LocalDate.now());
    public static final MenuItem baconWrappedChicken = new MenuItem(BACON_WRAPPED_CHICKEN_ID, riga, "Bacon wrapped chicken", 70000, LocalDate.now());
    ...
    public static final MenuItem khachapuriInAdjarianStyle = new MenuItem(KHACHAPURI_IN_ADJARIAN_STYLE_ID, suliko, "Khachapuri in Adjarian style", 50000, LocalDate.now());
    public static final MenuItem khachapuriInImeretianStyle = new MenuItem(KHACHAPURI_IN_IMERETIAN_STYLE_ID, suliko, "Khachapuri in Imeretian style", 50000, LocalDate.now());
    ...
    public static MenuItemTo getNew() {
        return new MenuItemTo(null, "NewMeal", BLUE_LAGOON_ID, 50000, LocalDate.now());
    }

    public static MenuItemTo getUpdated() {
        return new MenuItemTo(1, "UpdatedMeal", BLUE_LAGOON_ID, 40000, LocalDate.now());
    }

    public static MenuItemTo getInvalid() {
        return new MenuItemTo(1, "Tasty desert", BLUE_LAGOON_ID, 40000, LocalDate.now());
    }
}
