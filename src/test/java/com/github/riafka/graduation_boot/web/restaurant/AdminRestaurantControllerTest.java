...
import com.github.riafka.graduation_boot.web.user.UserTestData;
...
import static com.github.riafka.graduation_boot.web.GlobalExceptionHandler.EXCEPTION_DUPLICATE_NAME;
...
class AdminRestaurantControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL + BLUE_LAGOON_ID))
                .andDo(print())
                .andExpect(status().isNoContent());
        assertFalse(restaurantRepository.findById(BLUE_LAGOON_ID).isPresent());
    }
